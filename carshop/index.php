...
<body>
  <form action="insert.php" method="post">
    <p>
      ...
      <input required type="link" name="img" id="img" />
    </p>
    <p>
      ...
      <?php foreach ($cars as $car) { ?>
        <div class="col ">
          <div class="card h-100  ">
            <img src="<?php echo $car["img"]; ?>" class="card-img-top  " alt="...">
            <div class="card-body">
              <h5 class="card-title"><?php echo $car["model"]; ?></h5>
              <h5 class="card-title"><?php echo $car["color"]; ?></h5>
              <h5 class="card-title"><?php echo $car["price"]; ?> $</h5>
              <form action="del.php" method="post">
                <input type="submit" name="del" value="<?php echo $car["carid"]; ?>" />
              </form>
